        ...
        if($tour_travel_agent_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','tour-travel-agent'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
                    <?php if( get_theme_mod( 'tour_travel_agent_navigation_hide',true) != '') { ?>
                        <?php if( get_theme_mod( 'tour_travel_agent_post_navigation_position','bottom') == 'top' || get_theme_mod( 'tour_travel_agent_post_navigation_position','bottom') == 'both')  { ?>
                            <div class="navigation my-3">
                                <?php tour_travel_agent_post_navigation();?>
                    ...
                    ?>
                    <?php if( get_theme_mod( 'tour_travel_agent_navigation_hide',true) != '') { ?>
                        <?php if( get_theme_mod( 'tour_travel_agent_post_navigation_position','bottom') == 'bottom' || get_theme_mod( 'tour_travel_agent_post_navigation_position','bottom') == 'both')  { ?>
                            <div class="navigation my-3">
                                <?php tour_travel_agent_post_navigation();?>
                                <div class="clearfix"></div>
                            </div>
